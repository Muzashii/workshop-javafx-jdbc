...
public class SellerFormController implements Initializable {
	...
	public void setSeller(@SuppressWarnings("exports") Seller entity) {
		this.entity = entity;
	}

	public void SetServices(@SuppressWarnings("exports") SellerService service,
			@SuppressWarnings("exports") DepartmentService departmentservice) {
	...
	private Seller getFormData() {
		...
		// testa se o nome nao é nulo ou vazio
